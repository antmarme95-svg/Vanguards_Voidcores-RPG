// The three Origin Factions. Everything an origin touches lives here:
// passive ability data, starting city, recruiter, rival power, scene theming.
// Ports 1:1 to a Godot Resource per origin.
...
export const ORIGINS = [
  {
    ...
    heightRange: [0.97, 1.13], // tall and wiry
    theme: {
      accent: "#46e6ff",
      sky: "#7fd4ff",
      ambient: "#bfe8ff",
  ...
  },
  {
    ...
    heightRange: [0.92, 1.08], // dense and broad
    theme: {
      accent: "#ff9d4d",
      sky: "#3a2420",
      ambient: "#ffb37a",
  ...
  },
  {
    ...
    heightRange: [0.9, 1.1], // low crouch to lanky
    theme: {
      accent: "#4dff9d",
      sky: "#2c4a44",
      ambient: "#9fd8c5",
